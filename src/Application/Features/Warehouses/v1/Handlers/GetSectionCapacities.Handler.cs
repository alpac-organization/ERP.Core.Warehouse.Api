...
{
   public class GetSectionCapacitiesHandler(IUnitOfWork _unitOfWork, IErrorManager _errorManager) : BaseValidatorHandler<GetSectionCapacitiesQuery, SectionCapacitiesDto>(_unitOfWork, _errorManager)
   {
