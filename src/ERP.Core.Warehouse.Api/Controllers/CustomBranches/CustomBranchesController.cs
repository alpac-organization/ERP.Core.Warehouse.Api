...
public class CustomBranchesController(IMediator _mediator) : ApiControllerBase
{
    ...
    [ProducesResponseType(typeof(List<CustomBranchListItemDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ErrorResponse), StatusCodes.Status500InternalServerError)]
    public async Task<List<CustomBranchListItemDto>> GetCustomsBranchesAsync(
